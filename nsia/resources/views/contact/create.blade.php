    ...
    <section class="content" style="height:50%;width:700px; " >
       <div class="card" class="m-auto">
           <div class="card-header">
             <h3 class="card-title">Ajouter un contact</h3> <br/>
               ...
               <form action="{{ route('contact.store') }}" method="POST">
                   ...
                   @method('POST')
                       ...
                       <div class="form-group">
                         <label for="categorie">Selectionner le fournisseur</label>
                       ...
                       <div class="form-group">
                        ...
                        <input type="tel" class="form-control" value="{{ old('contact') }}" name="contact">
                        @error('contact')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
