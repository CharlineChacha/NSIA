               ...
               <form action="{{ route('service.store') }}" method="POST">
                   ...
                   @method('POST')
                     ...
                     <div class="form-group">
                       ...
                       <input type="text" class="form-control" value="{{ old('nom') }}" name="nom" placeholder="Entrer le nom du service">
                       @error('nom')
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ old('nomchef') }}" name="nomchef" placeholder="Entrer le nom du chef service">
                        @error('nomchef')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
