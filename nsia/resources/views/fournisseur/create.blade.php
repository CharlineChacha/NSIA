     ...
     <section class="content" style="height:50%;width:700px; " >
        <div class="card" class="m-auto">
            <div class="card-header">
              <h3 class="card-title">Ajouter un fournisseur</h3> <br/>
                ...
                <form action="{{ route('fournisseur.store') }}" method="POST">
                    ...
                    @method('POST')
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ old('fournisseur') }}" name="fournisseur" placeholder="Entrer le nom du fournisseur">
                        @error('fournisseur')
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ old('adresse') }}" name="adresse" placeholder="Entrer l'adresse">
                        @error('adresse')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
